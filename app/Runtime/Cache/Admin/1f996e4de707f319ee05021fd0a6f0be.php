...
<div class="content">
  ...
  <!--END 选项卡-->
   ...
   <!--搜索 BEGIN-->
<div class="search">
    <form action="<?php echo U('Admin/Route/ls');?>" method="post">
        <table width="100%">
            <td width="100">
...
<!--END 搜索--> 
  ...
  <!--列表 BEGIN-->
  <div class="list">
      <form action="<?php echo U('Admin/Route/del');?>" method="post" class="del-form">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          <?php if(empty($list)): ?><tr>
              <td colspan="11" class="empty">暂无相关关键字信息</td>
            </tr>
          <?php else: ?>
